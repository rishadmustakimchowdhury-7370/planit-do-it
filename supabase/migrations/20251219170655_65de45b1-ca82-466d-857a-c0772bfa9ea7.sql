-- Fix the handle_new_user trigger to check for pending invitations first
-- This prevents creating duplicate tenants when users accept team invitations
...
DECLARE
  ...
  v_invitation record;
BEGIN
  -- Check if user was invited to a team
