...
function generateEmailHTML(
  ...
  const signatureHTML = showCompanyName 
    ? `<p style="margin:15px 0 0;color:#1e293b;font-size:15px;">Best regards,<br/><strong style="color:#00008B;">${organizerName}</strong><br/><span style="color:#64748b;font-size:13px;">${displayCompanyName}</span></p>`
    : `<p style="margin:15px 0 0;color:#1e293b;font-size:15px;">Best regards,<br/><strong style="color:#00008B;">${organizerName}</strong></p>`;
